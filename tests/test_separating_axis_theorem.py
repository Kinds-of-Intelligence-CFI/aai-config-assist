...
class TestSeparatingAxisTheorem(unittest.TestCase):
    ...
    def test_apply_separating_axis_theorem_with_squares_where_one_square_is_rotated_2(self):
        # Rectangle 1
        center1 = np.array([3, 3])
        width1 = 2.5
        height1 = 2.5
        ...
        expected_mtv = np.array([0.51112159, 0.29509619])
        result_mtv = apply_separating_axis_theorem(rectangle1, rectangle2)

        self.assertTrue(np.all(np.isclose(expected_mtv, result_mtv)))

    def test_apply_separating_axis_theorem_with_squares_where_one_square_is_rotated_3(self):
        # Rectangle 1
        center1 = np.array([3, 3])
        width1 = 2.5
        height1 = 2.5
