...
def get_default_item_parameter(
    item_name: str, param_name: str, default_item_params: Dict
) -> Dict:
    ...
    try:
        ...
        raise KeyError(
            f"The parameter name {param_name} is not defined in the default definitions. "
    ...
    try:
        ...
        raise KeyError(
            f"The item {item_name}'s {param_name} value is not defined in the default definitions. "
